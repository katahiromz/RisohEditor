...
[よくある質問]
    ...
    質問 4. なぜVisual Studioでコンパイルすると、文字化けするの？
      ...
      答え：rc.exe は UTF-16 を正しくサポートしていますが、Visual Studio 2022 より前では、
            UTF-8 ファイルを読み込むと出力データが文字化けします。
            Visual Studio 2022以降を使用してください。

    質問 5. インストーラなしとポータブル版の違いは何？

      答え：ポータブル版はレジストリを使わず、iniファイルを使います。

    質問 6. 64ビットをサポートしていますか？

      答え：はい、サポートしています。

    質問7. WonResとは何ですか？ 

      答え：Win32リソースデータを操作するためのツールです。
            リソースデータの読み込みや保存が可能で、暗号化・復号機能も備えています。 
            詳細は https://github.com/katahiromz/WonRes をご覧ください。
