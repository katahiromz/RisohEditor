...
RE_FILES="README.txt README-JPN.txt README-ITA.txt README-KOR.txt LICENSE.txt Standardize.md HYOJUNKA.txt TRANSLATORS.txt src/resource.h build/RisohEditorPortable.exe mcdx/MESSAGETABLEDX.md"
...
if [ ! -e build/RisohEditorPortable.exe ]; then
    echo ERROR: build/RisohEditorPortable.exe doesn\'t exists.
    exit 3
fi
