...
// and tlb_binary_from_text used to be defined here. They have been moved
// into MMainWnd (RisohEditor.cpp) and renamed to
// MMainWnd::DoDfmTextFromBinary, MMainWnd::DoDfmBinaryFromText,
...
// NOTE: EntrySet::load_msg_table and EntrySet::load_rc (and the
// mcdx-on-a-worker-thread helper they used) have been moved into MMainWnd
// (RisohEditor.cpp) and renamed to MMainWnd::DoCompileMsgTable and
// MMainWnd::DoCompileRC, since they were only ever called from there.
