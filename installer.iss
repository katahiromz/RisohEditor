...
; DefaultDirName={pf}\RisohEditor ; NOTE: Fix #111
...
OutputDir=.
OutputBaseFilename=RisohEditor-5.5.1-installer
...
VersionInfoProductTextVersion=5.5.1
