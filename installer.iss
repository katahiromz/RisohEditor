...
OutputDir=.
OutputBaseFilename=risoheditor-4.9.5-setup
...
VersionInfoProductTextVersion=4.9.5
VersionInfoProductVersion=4.9.5
VersionInfoVersion=4.9.5
