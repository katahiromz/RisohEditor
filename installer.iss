...
; DefaultDirName={pf}\RisohEditor ; TODO: Fix #111
...
OutputDir=.
OutputBaseFilename=RisohEditor-5.5.3-installer
...
VersionInfoCopyright=Copyright (C) 2017-2021 Katayama Hirofumi MZ.
VersionInfoDescription=Win32 Resource Editor
VersionInfoProductName=RisohEditor
VersionInfoProductTextVersion=5.5.3
VersionInfoProductVersion=5.5.3
...
Source: "data\bin\tlb2idl64.exe"; DestDir: "{app}\data\bin"; Flags: ignoreversion
Source: "data\bin\tlb2idl32.exe"; DestDir: "{app}\data\bin"; Flags: ignoreversion
