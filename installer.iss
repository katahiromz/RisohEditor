...
OutputDir=.
OutputBaseFilename=RisohEditor-5.4.7-installer
...
VersionInfoProductTextVersion=5.4.7
VersionInfoProductVersion=5.4.7
VersionInfoVersion=5.4.7
...
japanese.ReadmeEnglish=ReadMe (‰pŒê)
japanese.ReadmeJapanese=“Ç‚ñ‚Å‚Ë (“ú–{Œê)
japanese.LicenseEnglish=ƒ‰ƒCƒZƒ“ƒX (‰pŒê)
